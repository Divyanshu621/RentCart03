...
import { z } from 'zod';
import { Loader2, Mail, Lock, Eye, EyeOff, User, Phone, MapPin, Home, FileCheck, ArrowRight, Sparkles } from 'lucide-react';
...
function LoginForm({
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const result = await api.googleAuth({ email, name });
